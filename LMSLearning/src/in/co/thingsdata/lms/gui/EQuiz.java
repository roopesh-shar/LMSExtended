...
public class EQuiz extends Screen {
	...
	public void initializeQuizScreen() throws SQLException{
		frame= GUIUtil.createFrame("E Quiz");
		GUIUtil.setSize(frame, 600, 800);
	...
	public void loadAllQuestionsForUser() throws SQLException {
		quizQuestions = Business.getInstance().getQuizQuestionfromDB(5);
	}

	/*
	 * public void displayQuestionForQuestionNumber(int questionNumber){ set
	 * Question questionSet[questionNumber-1][0]; set choiceA
	 * questionSet[questionNumber-1][1]; set ChoiceB
	 * questionSet[questionNumber-1][2]; set ChoiceC
	 * questionSet[questionNumber-1][3]; Set ChoiceD
	 * questionSet[questionNumber-1][4]; }
	 */

	public void displayQuestions(JFrame questionFrame) {
		...
		lblmess = GUIUtil.createLabel("Choose a correct anwswer");
		GUIUtil.setForeGroundColor(lblmess, Color.BLUE);
		lblmess.setFont(new Font("Arial", Font.BOLD, 11));
		btnext = GUIUtil.createButton("Next");
		GUIUtil.setForeGroundColor(btnext, Color.BLUE);
	...
	public void displayReport() {
		...
		for (int i = 0; i < quizQuestions.length; i++) {
			lblQuestion[i] = new JLabel("Question " + (i + 1) + ": "
					+ questionAnswerSet[i][0]);
			lblAnswer[i] = new JLabel("Correct Answer : "
					+ questionAnswerSet[i][1]);
		...
		reportPanel.add(Box.createRigidArea(new Dimension(0, 10)));
		lblCountCorrectAnswer = new JLabel("Count of Correct Answer is :"
				+ calCorrectAnswer());
